...
static const char cursor_size[] =
    "20"; /* Make sure it's a valid integer, otherwise things will break */
...
static const char *const autostart[] = {
    "waybar", NULL,     "syncthing", "--no-browser", NULL, "swaybg",
    "-c",     "000000", NULL,        "mako",         NULL, NULL /* terminate */
};
...
#define TAGKEYS(KEY, SKEY, TAG)                                                \
  {MODKEY, KEY, view, {.ui = 1 << TAG}},                                       \
    ...
    // { MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,SKEY,toggletag, {.ui = 1 <<
    // TAG} }
...
static const char *menucmd[] = {
    "wmenu-run", "-i",      "-f", "IosevkaTerm Nerd Font 10",
    "-N",        "#000000", "-n", "#C1C1C1",
    "-M",        "#79241F", "-m", "#000000",
    "-S",        "#79241F", "-s", "#000000",
    NULL};
static const char *browser[] = {"librewolf", NULL};
static const char *leisure[] = {"waterfow", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY, XKB_KEY_w, spawn, {.v = leisure}},
    ...
    {MODKEY | ALT | WLR_MODIFIER_CTRL, XKB_KEY_s, spawn,
     SHCMD("hyprpicker -a")},
    ...
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn,
     SHCMD("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+")},
    ...
    {0, XKB_KEY_XF86MonBrightnessUp, spawn,
     SHCMD("brightnessctl -e4 -n2 set 5%+")},
